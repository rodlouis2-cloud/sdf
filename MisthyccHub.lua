local COLORS = {
PrimaryDarkBackground = Color3.fromRGB(25, 0, 40),
CardBackground = Color3.fromRGB(35, 0, 55),
Borders = Color3.fromRGB(140, 0, 255),
GradientStart = Color3.fromRGB(90, 0, 180),
GradientEnd = Color3.fromRGB(170, 0, 255),
...
KnobOn = Color3.fromRGB(220, 120, 255),
KnobOff = Color3.fromRGB(70, 70, 70),
ButtonBG = Color3.fromRGB(70, 0, 120),
ButtonHover = Color3.fromRGB(120, 0, 200),
SliderTrack = Color3.fromRGB(55, 0, 90),
SliderFill = Color3.fromRGB(180, 0, 255),
SectionBG = Color3.fromRGB(45, 0, 70),
SectionBorder = Color3.fromRGB(140, 0, 255),
MiniTitle = Color3.fromRGB(100, 0, 180),
MiniTitleBorder = Color3.fromRGB(200, 0, 255),
TabActive = Color3.fromRGB(180, 0, 255),
TabInactive = Color3.fromRGB(25, 25, 25),
TabHover = Color3.fromRGB(140, 0, 220),
}

local GRADIENT_SEQUENCE = ColorSequence.new({
    ColorSequenceKeypoint.new(0, COLORS.GradientStart),
    ColorSequenceKeypoint.new(0.3, COLORS.GradientEnd),
    ColorSequenceKeypoint.new(0.6, COLORS.GradientStart),
...
ZenoToggleBtn.BackgroundColor3 = COLORS.PrimaryDarkBackground
ZenoToggleBtn.BackgroundTransparency = 0.28  -- black with ~72% opacity = transparency
ZenoToggleBtn.Text = "Fun Hub ▼"
ZenoToggleBtn.TextColor3 = COLORS.Text
...
ZenoStroke.Color = COLORS.Borders
ZenoStroke.Thickness = 2
ZenoStroke.Parent = ZenoToggleBtn
local ZenoGradient = Instance.new("UIGradient", ZenoStroke)
ZenoGradient.Color = GRADIENT_SEQUENCE
...
Main.Size = UDim2.new(0, 650, 0, 700)
Main.Position = UDim2.new(0.5, -frameWidth/2, 0.5, -frameHeight/2)
Main.AnchorPoint = Vector2.new(0.5, 0.5)
Main.BackgroundColor3 = Color3.fromRGB(0, 150, 180)
...
Stroke.Color = COLORS.Borders
Stroke.Thickness = 2
Stroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border

local BorderGradient = Instance.new("UIGradient", Stroke)
BorderGradient.Color = GRADIENT_SEQUENCE
...
DragHandle.TextColor3 = COLORS.TextDim
...
Minimize.BackgroundColor3 = COLORS.Borders
Minimize.Text = "-"
...
ToggleUI.BackgroundColor3 = COLORS.Borders
...
PlayerList.ScrollBarImageColor3 = COLORS.Text
PlayerList.ZIndex = 2
...
local function CreatePlayerRow(plr)
	...
	Semi.BackgroundColor3 = COLORS.ButtonBG
	Semi.Text = "SEMI ("..configData.SemiKeybind..")"
	Semi.TextColor3 = COLORS.Text
	...
	Full.BackgroundColor3 = COLORS.Accent
	Full.TextColor3 = COLORS.PrimaryDarkBackground
...
Check.BackgroundColor3 = BalloonEnabled and COLORS.Accent or COLORS.ToggleOff
Check.Text = ""
...
Refresh.BackgroundColor3 = COLORS.ButtonBG
...
local function getMutationInfo(model)
    ...
    local mutationColor = COLORS.Text
...
local function createPlayerESP(player)
    ...
    fullHighlight.FillColor = COLORS.Text  -- Pink glow
    fullHighlight.FillTransparency = 0.4
    fullHighlight.OutlineColor = COLORS.Text  -- White outline
    ...
    if torso then
        ...
        torsoBox.Color3 = COLORS.Text  -- Orange for torso
...
function createUnlockBaseUI()
    ...
    for i = 1, 3 do
        ...
        btn.MouseEnter:Connect(function()
            btn.BackgroundColor3 = COLORS.Text
            s.Transparency = 0
        end)
...
local function createMineESP(mine)
    ...
    selectionBox.Color3 = COLORS.Text
    ...
    textLabel.TextStrokeColor3 = COLORS.Text
...
local COLORS = {
    PrimaryDarkBackground = Color3.fromRGB(0, 150, 180),
    CardBackground = Color3.fromRGB(0, 150, 180),
    Borders = Color3.fromRGB(0, 200, 240),
    GradientStart = Color3.fromRGB(0, 150, 180),
    GradientEnd = Color3.fromRGB(0, 180, 220),

    Accent = Color3.fromRGB(0, 200, 240),
    AccentBright = Color3.fromRGB(0, 220, 255),
    Text = Color3.fromRGB(0, 0, 0),
    TextDim = Color3.fromRGB(30, 30, 30),
    ToggleOn = Color3.fromRGB(0, 200, 240),
    ToggleOff = Color3.fromRGB(0, 0, 0),
    KnobOn = Color3.fromRGB(0, 200, 240),
    KnobOff = Color3.fromRGB(50, 50, 50),
    ButtonBG = Color3.fromRGB(0, 150, 180),
    ButtonHover = Color3.fromRGB(0, 180, 220),
    SliderTrack = Color3.fromRGB(0, 120, 150),
    SliderFill = Color3.fromRGB(0, 200, 240),
    SectionBG = Color3.fromRGB(0, 150, 180),
    SectionBorder = Color3.fromRGB(0, 180, 220),
    MiniTitle = Color3.fromRGB(0, 150, 180),
    MiniTitleBorder = Color3.fromRGB(0, 200, 240),
    TabActive = Color3.fromRGB(0, 200, 240),
    TabInactive = Color3.fromRGB(0, 0, 0),
    TabHover = Color3.fromRGB(0, 180, 220),
}
...
function OpenInstantStealUI(anchorPanel)
    ...
    main.BackgroundColor3 = COLORS.Text
    ...
    subLabel.TextColor3 = COLORS.Text
    subLabel.TextSize = 9
    ...
    closeBtn.BackgroundColor3 = COLORS.Text
    closeBtn.Text = "x"
    ...
    keybindBtn.BackgroundColor3 = COLORS.Text
    keybindBtn.Text = "[ F ]"
    ...
    keybindBtn.MouseButton1Click:Connect(function()
        ...
        keybindBtn.TextColor3 = COLORS.Text
        TweenService:Create(kbStroke, TweenInfo.new(0.15), {Color = COLORS.Text}):Play()
    ...
    teleportBtn.BackgroundColor3 = COLORS.Text
    ...
    activateBtn.BackgroundColor3 = COLORS.Text
    ...
    local function createToggleRow(parent, yPos, labelText, defaultState, configKey)
        ...
        local function applyState(on, animate)
            local targetColor = on and COLORS.Text or COLORS.Text
        ...
        clickBtn.MouseEnter:Connect(function()
            TweenService:Create(row, TweenInfo.new(0.12), {BackgroundColor3 = COLORS.Text}):Play()
        end)
    ...
    divider2.BackgroundColor3 = COLORS.Text
    ...
    sliderBar.BackgroundColor3 = COLORS.Text
    ...
    sliderFill.BackgroundColor3 = COLORS.Text
...
creditsFrame.BackgroundColor3 = COLORS.Text
...
local function createMiniToggle(parent, label, order, onToggle, bindId)
    ...
    addCorner(switch, 9)
    addStroke(switch, COLORS.Text, 1)
...
local function invisCreateServerGhost(position)
    ...
    ghost.Size = Vector3.new(3, 3, 3); ghost.Color = COLORS.Text
    ...
    bl.Text = "LAGBACK DETECTED"; bl.TextColor3 = COLORS.Text
...
do
    ...
    do
        ...
        addStroke(aiSwitch, COLORS.Text, 1)
